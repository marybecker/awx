...
Mary Becker - Last Updated 2021-06-16
------------------------------------------------------------------------------------------
...
headerList = ['ProjectIdentifier', 'staSeq', 'ActivityTypeCode', 'ActivityStartDate', 'ActivityTime',
              ...
              'ReachWidthMeasureUnitCode', 'PassCount', 'Amps', 'Pulses', 'CollectionEfficiencyEst',
              'TotalEnergizedMeasure', 'TotalEnergizedMeasureUnit', 'Volts', 'DutyCycle']

SQLinsert = 'INSERT INTO ' + db_scm + '.activitybio ' \
                                  '(ProjectIdentifier, staSeq, ActivityTypeCode, ActivityStartDate, ActivityTime, ' \
                                  ...
                                  'ReachLengthMeasureUnitCode, ReachWidthMeasureValue, ReachWidthMeasureUnitCode, PassCount, Amps, Pulses, ' \
