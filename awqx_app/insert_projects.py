...
------------------------------------------------------------------------------------------
Given input directory of excel template spreadsheets with new project information,
...
requirements are inserted into the projects table """
...
ftp = in_dir
folder = 'Upload/'
insert_type = 'Projects/'
fdir = glob.glob(ftp+'**/'+folder+insert_type+'*Projects*.xlsx')
