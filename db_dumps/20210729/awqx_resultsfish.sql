...
CREATE TABLE `resultsfish` (
  ...
  PRIMARY KEY (`ActivityIdentifier`,`SubjectTaxonomicName`,`FrequencyClassDescriptorCode`,`FrequencyClassDescriptorUnitCode`,`LowerClassBoundValue`,`UpperClassBoundValue`),
  ...
  CONSTRAINT `resultsfish_ibfk_1` FOREIGN KEY (`ActivityIdentifier`) REFERENCES `activitybio` (`ActivityIdentifier`),
...
--
-- Dumping data for table `resultsfish`
--

LOCK TABLES `resultsfish` WRITE;
/*!40000 ALTER TABLE `resultsfish` DISABLE KEYS */;
/*!40000 ALTER TABLE `resultsfish` ENABLE KEYS */;
UNLOCK TABLES;
