...
CREATE TABLE `results` (
  ...
  CONSTRAINT `results_ibfk_1` FOREIGN KEY (`CharacteristicName`) REFERENCES `characteristic` (`Name`),
  CONSTRAINT `results_ibfk_2` FOREIGN KEY (`ResultValueTypeName`) REFERENCES `resultvaluetype` (`Name`),
  CONSTRAINT `results_ibfk_3` FOREIGN KEY (`ResultStatusIdentifier`) REFERENCES `resultstatus` (`Name`)
...
-- Dump completed on 2022-06-27 12:01:09
